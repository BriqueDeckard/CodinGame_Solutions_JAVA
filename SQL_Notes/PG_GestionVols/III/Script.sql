...
SELECT *
INTO export_vols
FROM vue_affectation
WHERE nompilote 
LIKE 'a%';

CREATE INDEX idx_nompilote 
ON export_vols 
USING btree(nompilote); --USING sert a indiquer le type de structure qu'on va utiliser pour creer notre index. btree est un arbre balancé.
