...
OR REPLACE VIEW adresses AS (
	...
	FROM
		pilote pil
		INNER JOIN ville ON ville.code = pil.fk_ville
);
...
FROM
	pilote pil
	INNER JOIN adresses adr ON adr.nopilote = pil.nopilote
	AND adr.ville LIKE '%Paris%'
	AND pil.dateembauche < '2001-01-01';